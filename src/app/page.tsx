...
<div className='flex flex-col items-center'>
  ...
  <div className='flex flex-col items-center'>
    ...
    <div className="flex gap-4">
      <a  className="flex items-center bg-black text-white px-4 py-2 rounded-md">
        <Image src="/Image/iphone.png" alt="Apple logo" width={20} height={20} className="mr-2" />
        <span>Download on the<br />App Store</span>
      </a>
      <a  className='flex items-center bg-black text-white px-4 py-2 rounded-md'>
        <Image src="/Image/playstore.png" alt="Google Play logo" width={20} height={20} className="mr-2" />
      ...
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 bg-black'>
        <div>
          ...
          <div className='flex gap-[20px]'>
              <ImFacebook className='text-[34px] mt-[28px]  text-amber-500 bg-stone-50 pt-[5px] pb-[5px] rounded-[5px]'/>
              <BsTwitter className='text-[34px] mt-[28px]  text-amber-500 bg-stone-50 pt-[5px] pb-[5px] rounded-[5px]'/>
              <GrLinkedinOption  className='text-[34px] mt-[28px]  text-amber-500 bg-stone-50 pt-[5px] pb-[5px] rounded-[5px]'/>
              </div>
